...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'tambah_menu') {
        ...
        if ($harga > 99999) {
            // Jika harga melebihi batas, batalkan proses dan beri pesan error
            $feedback = [
                'type' => 'danger', 
            ...
            exit; // Hentikan script agar tidak lari ke query INSERT
        }

        // Proses Upload Foto (Hanya berjalan jika harga valid)
        ...
        // Jalankan Query INSERT (Aman dari crash Out of Range)
