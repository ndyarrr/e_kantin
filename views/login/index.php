...
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="login-card">
            ...
            <div class="role-panel" id="rolePanel">
                ...
                <!-- Gambar role — fixed container -->
                <div class="role-img-wrap">
                    <img id="roleImg" src="" alt="Role">
                </div>

                <!-- Label role -->
                <div class="role-label" id="roleLabel">Siswa</div>
            ...
            <div class="form-panel">
                <div class="form-title">Login Sebagai <span id="formRoleLabel">Siswa</span></div>
                ...
                <!-- Form action — naik 2 level ke auth/ -->
        ...
        <p class="login-footer">&copy;
            <?= date('Y') ?> E-Kantin &mdash; SMKN 1 Boyolangu
        </p>
    </div>
    ...
    <script>
        ...
        // Toggle mata dengan indikator open/closed
        ...
        if (alertEl) {
            ...
            }, 1000); // tampil 2 detik lalu fade out
        }
        ...
        updateRole(); // ganti yang lama dengan ini (sudah ada di bawah)
