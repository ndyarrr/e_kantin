...
$statMenu = (int) mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM menu m JOIN toko t ON m.id_toko = t.id_toko WHERE m.deleted_at IS NULL AND t.deleted_at IS NULL"))['c'];
?>
